...
import br.net.digitalzone.osworks.domain.service.CadastroClienteService;
...
public class ClienteController {
	...
	@GetMapping("/clientes/q")
	public List<Cliente> listarPorNome(@RequestParam(value = "name") String nome) {
